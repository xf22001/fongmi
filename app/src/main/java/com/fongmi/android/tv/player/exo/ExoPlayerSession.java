...
final class ExoPlayerSession {
    ...
    private static final class DecodeTrackSelectorFactory implements TrackSelector.Factory {
        ...
        private final List<DefaultTrackSelector> trackSelectors = new ArrayList<>(2);
        private int decode;
        ...
        public TrackSelector createTrackSelector(@NonNull Context context) {
            DefaultTrackSelector trackSelector = ExoUtil.buildTrackSelector(decode);
        ...
        private void setDecode(int decode) {
            ...
            this.decode = decode;
            for (DefaultTrackSelector trackSelector : trackSelectors) ExoUtil.setDecodePreferences(trackSelector, decode);
        }
    }
}
